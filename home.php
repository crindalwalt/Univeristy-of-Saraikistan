...
<body>
    ...
    <?php include "components/_navbar3.php"; ?>
        ...
        if($alert){
            $type = "Success";
            $statement = "Your account has been created";
        ...
        <div id="alertx" class="alert alert-warning alert-dismissible fade show" role="alert">
           ...
           <strong>'. $statement.' as '. $_SESSION['username'] . '
           <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
         </div>
    </div>';
    include "backend/dbcon.php";
    $not = "INSERT INTO `notifications` ( `not_type`, `not_statement`, `not_created`) VALUES ( '$type', '$statement', 'current_timestamp(6).000000');";
    $not_add = mysqli_query($connection,$not);
        }
